...
function UserProf() {
  ...
  async function updateUserData(values: any) {
    try {
      ...
      const response = await Axios.patch(
        "http://localhost:3000/user-information",
        userData,
        {
          headers: {
      ...
      console.error(err);
      alert(
        `Erro Perfil: ${err.response?.data?.message || "Erro ao atualizar dados"}`,
      );
    }
  }
  ...
  async function updateCarData(values: any) {
    try {
      ...
      const response = await Axios.patch(
        "http://localhost:3000/register-car-information",
        carData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      console.error(err);
      alert(
        `Erro Veículo: ${err.response?.data?.message || "Erro ao atualizar veículo"}`,
      );
    }
  }
          ...
          >
            ...
            <div className="flex justify-end mt-2">
              ...
              >
                ...
                <p className="capitalize font-semibold whitespace-nowrap">
                  salvar informações
                </p>
              </button>
            </div>
